...
public class Cat implements Run, Jump {
    ...
    public boolean jump(float heightJump) {
        ...
        if(maxHeightJump - heightJump < 0){
            System.out.println("Кот " + name + " не смог пройти испытание прыжка на " + heightJump + " метров");
            return false;
        }
        else{
            System.out.println("Кот " + name + " преодолел испытание прыжка, прыгнув на " + heightJump + " метров");
            return true;
        }
    }
    ...
    public boolean run(float runDistance) {
        ...
        if(maxRunDistance - runDistance < 0){
            System.out.println("Кот " + name + " не смог пройти преодолеть дистанцию на " + runDistance + " метров");
            return false;
        }
        else{
            System.out.println("Кот " + name + " преодолел дистанцию, пробежав " + runDistance + " метров");
            return true;
        }
    }
}
